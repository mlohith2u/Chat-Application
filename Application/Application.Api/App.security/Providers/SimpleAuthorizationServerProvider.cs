...
namespace Application.Api.App.security.Providers
{
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            using (var repo = new UserManager())
            {
                ...
                if (user.IsActive != false)
                {
                    ...
                    userid = user.UserUID.ToString();
                    CustomerId = user.StudentId;
            ...
            identity.AddClaim(new Claim(ClaimTypes.NameIdentifier, CustomerId));
            identity.AddClaim(new Claim(ClaimTypes.NameIdentifier, ismember.ToString()));
            identity.AddClaim(new Claim(ClaimTypes.NameIdentifier, loggedinid.ToString()));
        ...
        private string GetRoleName(string v)
        {
            ...
            var rolename = db.tblRoleMasters.Where(c => c.ID == id).Select(c => c.Role).FirstOrDefault();
            return rolename;
        }
